...
//
//  Created by a1091793 on 3/12/2015.
//
//
...
class RandomColourGen
{
    
    double rand;
    double golden_ratio_conjugate;
    
public:
    RandomColourGen()
    : rand(colour_uniform(default_rng_coulour)), golden_ratio_conjugate(0.618033988749895)
    {
